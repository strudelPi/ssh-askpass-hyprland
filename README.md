...
```
#!/bin/bash
notify-send "🔑 SSH" "Touch your YubiKey" -t 5000

# Only show password dialog if the prompt explicitly asks for a passphrase
# (non-sk keys or verify-required keys)
if echo "$1" | grep -qi "passphrase"; then
